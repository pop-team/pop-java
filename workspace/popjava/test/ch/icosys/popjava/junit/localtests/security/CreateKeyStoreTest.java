...
public class CreateKeyStoreTest {
	...
	public void full() throws Exception {
		...
		try (SSLSocket serverClient = (SSLSocket) socketFactory.createSocket(serverSocket.getInetAddress(),
				serverSocket.getLocalPort()); InputStream in = serverClient.getInputStream()) {
			// setup SNI
