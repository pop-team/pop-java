...
/**
 * Special test for the functionality to create a POPJava object in the same VM
 * as the creator.
 * 
 * @author beat
 *
...
public class JVMObjectTest {
	...
	public void testChainedObjectCreation2() {
		...
		LocalObject remote = PopJava.newActiveConnect(this, LocalObject.class,
				PopJava.getThis(local1).getAccessPoint());
	...
	public void multipleConnections() {
		...
		LocalObject remote = PopJava.newActiveConnect(this, LocalObject.class,
				PopJava.getThis(local1).getAccessPoint());
		LocalObject remote2 = PopJava.newActiveConnect(this, LocalObject.class,
				PopJava.getThis(local1).getAccessPoint());
