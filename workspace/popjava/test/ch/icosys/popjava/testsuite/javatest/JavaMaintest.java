...
public class JavaMaintest {
	...
	public static void main(String[] args) {
		...
		if (i == 1)
			...
			System.out.println("Java doesn't change the int passed as arguments " + i);
		...
		if (ii == 1)
			...
			System.out.println("Java doesn't change the Integer passed as arguments " + ii);
		...
		if (ia[0] == 1 && ia[1] == 2)
			...
			System.out.println("Java doesn't change the int[] passed as arguments ");

		InsideClass ic = new InsideClass(5, "FirstString");
		to.changeInsideClass(ic);
		if (ic.i == 10 && ic.test.equals("ChangedString"))
			System.out.println("Java changes the complex object passed by reference");
		else
