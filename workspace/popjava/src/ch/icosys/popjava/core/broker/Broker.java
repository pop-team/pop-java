...
public final class Broker {
     ...
     * @param inputSize  The size of the buffer containing the input parameters
     * @param outputSize The size of the buffer containing the method result (if any, else 0)
     */
