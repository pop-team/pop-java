...
public class Configuration {
	...
	public static KeyStoreOptions SSL_KEY_STORE_OPTIONS = new KeyStoreOptions("poplocal", "poplocalstore", "poplocalkey", "poplocal.jks", KeyStoreFormat.JKS, "tempCertificates");
	...
	public static void load(File file) throws IOException {
		...
		LOADED_PROPERTIES.load(new FileInputStream(file));
		
		// set properties to class values
		for (Object prop : LOADED_PROPERTIES.keySet()) {
	...
	public static void store() throws IOException {
		File file = new File(POPJAVA_CONFIG);
		
		// TODO make every constant in Properties and use this to save
		// LOADED_PROPERTIES.store(new FileOutputStream(file), "Generated by POP Java");
		
		try (PrintStream out = new PrintStream(file)) {
			out.println("# Generated by POP Java");
			out.format("%s  =  %s\n", "SSL_KEY_STORE_FILE", SSL_KEY_STORE_OPTIONS.getKeyStoreFile());
			out.format("%s  =  %s\n", "SSL_KEY_STORE_PASSWORD", SSL_KEY_STORE_OPTIONS.getStorePass());
			out.format("%s  =  %s\n", "SSL_KEY_STORE_PRIVATE_KEY_PASSWORD", SSL_KEY_STORE_OPTIONS.getKeyPass());
			out.format("%s  =  %s\n", "SSL_KEY_STORE_LOCAL_ALIAS", SSL_KEY_STORE_OPTIONS.getAlias());
			out.format("%s  =  %s\n", "SSL_KEY_STORE_TYPE", SSL_KEY_STORE_OPTIONS.getKeyStoreFormat());
			out.format("%s  =  %s\n", "SSL_KEY_STORE_TEMP_LOCATION", SSL_KEY_STORE_OPTIONS.getTempCertFolder());
		}
	}
}
