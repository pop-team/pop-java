...
public class POPAppService extends POPObjectMonitor implements AppService{
	...
	public POPAppService() {
		...
		defineMethod(c, "getPOPCAppID", 13, Semantic.Sequence
		...
		defineMethod(c, "queryService", 15, Semantic.Sequence
				| Semantic.Asynchronous, String.class, POPAccessPoint.class);
		defineMethod(c, "registerService", 16, Semantic.Sequence
				| Semantic.Asynchronous, String.class, POPServiceBase.class);
		defineMethod(c, "unregisterService", 17, Semantic.Sequence
